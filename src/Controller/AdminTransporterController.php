...
class AdminTransporterController extends AbstractController
{
    ...
    {
        return $this->render('admin_transporter/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_transporter/new.html.twig', [
    ...
    {
        return $this->render('admin_transporter/show.html.twig', [
            'transporter' => $transporter,
        ]);
    }
    ...
    public function edit(Request $request, Transporter $transporter, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_transporter/edit.html.twig', [
            'transporter' => $transporter,
            'form' => $form,
        ]);
    }
